...
public class MyStandardVideoController extends GestureVideoController implements View.OnClickListener, SeekBar.OnSeekBarChangeListener {
    ...
    private ImageView startPlayButtonGIF;
    ...
    protected void initView() {
        ...
        startPlayButtonGIF = controllerView.findViewById(R.id.start_play_gif);
...
//                Toast.makeText(getContext(), "isGIF: " + isGif, Toast.LENGTH_LONG).show();
                if(isGif) {
                    startPlayButton.setVisibility(View.GONE);
                    startPlayButtonGIF.setVisibility(View.VISIBLE);
                } else {
                    startPlayButton.setVisibility(View.VISIBLE);
                    startPlayButtonGIF.setVisibility(View.GONE);
                }
...
//                loadingProgress.setVisibility(GONE);
    ...
    // 设置是否为GIF，added by wangfengliang
    public void setGIF(boolean isGif) {
        this.isGif = isGif;
//        Toast.makeText(getContext(), "setGIF " + isGif, Toast.LENGTH_SHORT).show();
    ...
    public void setMediaPlayer(MediaPlayerControl mediaPlayer) {
        ...
        if(mediaPlayer != null) {
//            mediaPlayer.setMute(!isGif);        // GIF时静音，added by wangfengliang
            setMute(mediaPlayer.isMute());
//            Toast.makeText(getContext(), "静音2 " + mediaPlayer.isMute() + " " + this.isGif, Toast.LENGTH_SHORT).show();
        }
    }

    protected void setMute(boolean mute) {
        volume.setImageResource(!mute ? R.drawable.dkplayer_ic_action_volume_up : R.drawable.dkplayer_ic_action_volume_off);
